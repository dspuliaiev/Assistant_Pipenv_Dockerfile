...
class AssistantFunctionality:
    ...
    def dump(self):
        ...
        """
        with open('../Assistant_Pipenv/addressbook.csv', 'w', newline='\n', encoding='utf-8') as fh:
    ...
    def load(self):
        ...
        """
        file_path = '../Assistant_Pipenv/addressbook.csv'
    ...
    def dump_notes(self):
        ...
        """
        with open('../Assistant_Pipenv/notes.csv', 'w', newline='\n') as fh:
    ...
    def load_notes(self):
        ...
        """
        file_path = '../Assistant_Pipenv/notes.csv'
        if os.path.exists(file_path):
            with open(file_path, newline='\n') as fh:
                reader = csv.DictReader(fh)
                for row in reader:
